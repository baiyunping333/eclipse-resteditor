...
/**
 * Shortcut for a Sphinx HTML build
 * 
 * @author Thomas Calmant
 */
public class SphinxHtmlShortcut extends AbstractShinxShortcut {

	/** The Makefile rule used by this shortcut */
	public static final String MAKE_RULE = "html";
	...
	protected String getConfigName(final IProject aProject) {
		return "Auto Sphinx HTML for " + aProject.getName();
	}
